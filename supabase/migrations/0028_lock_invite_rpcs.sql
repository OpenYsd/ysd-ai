-- ============================================================
-- 0028 — إغلاق دوال الدعوة عن العميل (المرحلة الأخيرة، **كاسرة للقديم**)
--
-- ⚠️ **لا تُطبَّق قبل نشر التطبيق الجديد.**
--
-- الترتيب العددي هنا ليس ترتيب التطبيق: هذه آخر خطوة، بعد 0027 و0029 و0030
-- و0031 وبعد أن يصير الفرع حيًّا. التفصيل في docs/RELEASE-v0.8.1.md.
--
-- ── لماذا كاسرة ──
--
