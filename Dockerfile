...
#       الحلقة المحلّية) ولم يرَها المتصفّح (فلا تظهر الميزةُ أصلًا) — وهو
#       عطبٌ صامت: لوحةُ المنصّة تبدو صحيحة والمنتَجُ لا يعمل.
#       الغياب/الفراغ ⇒ مطفأة (وضعُ الإنتاج). و`1` حرفيًّا ⇒ مشتعلة.
# ============================================================
...
#
# ★ وكلُّ متغيّر `NEXT_PUBLIC_` يجب أن يُذكر هنا، لا في المنصّة وحدها.
#
# فالمنصّة تمرّر متغيّراتِها إلى **التشغيل**، وحزمةُ المتصفّح تُخبَز وقتَ
# **البناء**. فمتغيّرٌ غائبٌ عن هذه القائمة يراه الخادمُ ولا يراه المتصفّح.
#
# وقد وقع ذلك فعلًا في التجربة (Staging): كانت الرايةُ مضبوطةً في المنصّة،
# فبنَت السياسةُ في الخادم وفتحت وصلةَ الحلقة المحلّية، بينما خرجت حزمةُ
# المتصفّح والرايةُ فيها مطفأة — فلا لوحةَ في المحادثة ولا قسمَ في
# الإعدادات، وكلُّ شيءٍ يبدو مضبوطًا في لوحة المنصّة.
ARG NEXT_PUBLIC_SUPABASE_URL
ARG NEXT_PUBLIC_SUPABASE_ANON_KEY
ARG NEXT_PUBLIC_APP_NAME
ARG NEXT_PUBLIC_DEFAULT_LOCALE
#
# رايةُ التوليد المحلّيّ للصور.
#
# ★ ولا تُثبَّت قيمتُها هنا بحال.
#
# غيابُها أو خلوُّها ⇒ الميزةُ مطفأة (وهو وضعُ الإنتاج). والقيمةُ الحرفيّة
