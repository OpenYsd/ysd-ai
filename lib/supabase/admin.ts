 ...
 *
 * الاستعمالات: كتابة observability_events، وفحوص جاهزية HEAD خادمية بلا صفوف.
 * الجدول يمنع الكتابة على كل أدوار العميل (RLS بلا سياسة insert)،
 * وservice_role يتجاوز RLS — فتُكتب المقاييس من الخادم ولا يستطيع مستخدم حقن
 * أرقام مُلفّقة. فحوص الجاهزية تقرأ أسماء أعمدة ثابتة ولا تعيد محتوى مستخدم.
 *
 * أمان:
