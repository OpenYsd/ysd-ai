 ...
 *
 * المرحلة الأولى تُبقيه 1 عمدًا: كل المنطق والنقل والقياسات تعمل، وحدود
 * التقسيم لا تتغيّر بحرف. فيُختبر التوصيل معزولًا عن التقسيم، ويصير تفعيل
 * v2 لاحقًا إيداعًا من سطر واحد قابلًا للتراجع بسطر.
 */
